...
**Achievements**: Won the SAS® Viya® for Learners Challenge 2023
**Technical Stack**: SAS Viya, SAS Language
...
**Achievements**: I developed dashboards to monitor inventory and case data, maintained consistent working conditions while ensuring compliance with health accreditation standards for the lab, and accurately predicted the required inventory levels for various labs.
**Technical Stack**: Python, Excel, SQL
...
**Achievements:** Collected, organized, and analyzed data from various experiments, performed statistical analyses, and created visualizations for scientific publications.
**Technical Stack:** Excel, Prism, SPSS
---
### Projects
...
**Technical Stack:** Python, R, statsmodels, general linear model (GLM)
...
**Technical Stack:** REACT, Javascript, AWS, CSS, SQL, MongoDB
...
The project utilized a tech stack that includes C++, OpenMP and High-Performance Computing (HPC). The parallelization was achieved using both explicit and implicit multi-threading with OpenMP, optimizing computational tasks. Additionally, Windows threads were used for task distribution across cores.
...
**Technical Stack:** Python, R, Tensorflow
...
**Technical Stack:** Python, PyTorch, Keras
